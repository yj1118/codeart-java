...
final class SerializationMethodHelper {
	...
	private static final HashMap<SerializationMethodType, HashMap<Class<?>, Method>> _typeMethods = new HashMap<SerializationMethodType, HashMap<Class<?>, Method>>();
...
//	#region 构造
	...
	private static void initMethodCache() {
		_typeMethods.put(SerializationMethodType.Serialize, new HashMap<Class<?>, Method>());
		_typeMethods.put(SerializationMethodType.Deserialize, new HashMap<Class<?>, Method>());
	}
...
//
	private static Method GetMethodByCache(Class<?> type, SerializationMethodType methodType) {
		Method method = null;
		HashMap<Class<?>, Method> methodTypeMethods = null;
