...
//	#region 静态构造
	...
	private static Class<?> getTargetType(Class<?> classType, Field field) {
		if (classType != null)
			return classType;
		return field.getType();
	}

	private static MemberSerializationInfo createByCollection(Class<?> targetType, Field field, DTOMemberAttribute memberAttribute)
	{
