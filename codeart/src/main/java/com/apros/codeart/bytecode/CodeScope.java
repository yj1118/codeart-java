...
class CodeScope implements AutoCloseable {
	...
	private final ArrayList<BorrowedLocal> _locals = new ArrayList<BorrowedLocal>();
...
//	}
	...
	public void Open() {
//		_startEvalStackDepth = _owner.evalStack().size();
	}
...
//			if (_owner.evalStack().size() != (_startEvalStackDepth + _evalStackOverflow)) {
//				throw new InvalidOperationException(string.Format(
//						"Begin/End 代码段验证失败 - 开始代码段时，有 {0} 项在计算堆栈，但是结束时，还有 {1} 项，预期应该有 {2} 项", _startEvalStackDepth,
//						_owner._evalStack.Count, _startEvalStackDepth + _evalStackOverflow));
//			}
		} finally {
			_closed = true;
		}
