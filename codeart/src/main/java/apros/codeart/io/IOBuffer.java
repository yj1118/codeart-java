...
public final class IOBuffer {
	...
	private static Function<SizeConfig, Pool<ByteBuffer>> getPool = LazyIndexer.init((config) -> {
		return new Pool<ByteBuffer>(ByteBuffer.class, config.segmentCapacity(), 1, (isTempItem) -> {
			/*
	...
	private static record SizeConfig(int value, int segmentCapacity) {
	...
	private static final SizeConfig Byte128 = new SizeConfig(_Byte128, 64);
	private static final SizeConfig Byte256 = new SizeConfig(_Byte256, 32);
	private static final SizeConfig Byte512 = new SizeConfig(_Byte512, 16);
	private static final SizeConfig KB1 = new SizeConfig(_KB1, 64);
	private static final SizeConfig KB2 = new SizeConfig(_KB2, 32);
	private static final SizeConfig KB4 = new SizeConfig(_KB4, 16);
	private static final SizeConfig KB8 = new SizeConfig(_KB8, 8);
	private static final SizeConfig KB16 = new SizeConfig(_KB16, 4);
	private static final SizeConfig KB32 = new SizeConfig(_KB32, 4);
	private static final SizeConfig KB64 = new SizeConfig(_KB64, 4);
	private static final SizeConfig KB128 = new SizeConfig(_KB128, 4);
	private static final SizeConfig KB256 = new SizeConfig(_KB256, 4);
	private static final SizeConfig KB512 = new SizeConfig(_KB512, 4);
	private static final SizeConfig MB1 = new SizeConfig(_MB1, 4);
	private static final SizeConfig MB2 = new SizeConfig(_MB2, 4);
	private static final SizeConfig MB4 = new SizeConfig(_MB4, 4);
	private static final SizeConfig MB8 = new SizeConfig(_MB8, 4);
	private static final SizeConfig MB16 = new SizeConfig(_MB16, 4);
	private static final SizeConfig MB32 = new SizeConfig(_MB32, 4);
