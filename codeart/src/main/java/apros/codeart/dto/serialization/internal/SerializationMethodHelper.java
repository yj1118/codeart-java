    ...
    private static Method getMethodBySimple(Class<?> type, SerializationMethodType methodType) {
        ...
        if (method == null) {
            throw new IllegalArgumentException(
                    strings("apros.codeart", "NotFoundDTOSerializationMethod", TypeUtil.resolveName(type)));
        }
        return method;
...
//				return SerializationArgs.SerializerIndex;
            if (typeName.equals(IDTOWriter.class.getName()))
...
//				return SerializationArgs.DeserializerIndex;
            if (typeName.equals(IDTOReader.class.getName()))
                return SerializationArgs.ReaderIndex;
        }
        throw new IllegalArgumentException(strings("apros.codeart", "NotFoundParameterIndex", typeName));
    }
