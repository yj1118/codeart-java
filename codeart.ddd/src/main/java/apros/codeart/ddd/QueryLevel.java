...
public final class QueryLevel {
    ...
    public static final int HoldCode = 4;
     ...
     * <p>
     * 也就是说，Hold锁可以保证满足查询条件的现有数据和即将插入的数据都被锁住
     * <p>
     * 开启互斥锁和Hold 可以防止在查询中别的线程插入数据
     */
    public static final QueryLevel HOLD = new QueryLevel(HoldCode);
