...
public final class ConstructorParameterInfo {
    ...
    private final Parameter _original;
    ...
    private final PropertyMeta _propertyTip;
    ...
    private final ParameterRepository _tip;
    ...
    private final ConstructorRepositoryImpl _constructorTip;
    private final Method _loadData = null;

    /**
     * 获取运行时类型定义的加载方法，这常用于派生类定义的仓储实现
     */
    private final Function<Class<?>, Method> _getLoadData;
