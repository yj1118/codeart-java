...
//	#region 对外公开的方法
	...
	/// <returns></returns>
	public static long GetIdentity<T>()
	...
	/// <returns></returns>
	public static long GetSerialNumber<T>()
	where T:class,IAggregateRoot
	{
	     var objectType = typeof(T);
	     var model = DataModel.Create(objectType);
	...
	/// <typeparam name="T"></typeparam>
	/// <returns></returns>
	public static long GetIdentity<A,T>()
	where A:class,
	IAggregateRoot where T:DomainObject
	{
	...
	public static void Direct<T>(Action<DataConnection> action)
	...
	public static IEnumerable<dynamic> DirectQuery<T>(
	...
	/// <returns></returns>
	internal
	static T QuerySingle<T>(
	object id, QueryLevel level)
